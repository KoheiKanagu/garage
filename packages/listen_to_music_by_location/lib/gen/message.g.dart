...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    ...
    } else     if (value is SongDetails) {
      buffer.putUint8(130);
      writeValue(buffer, value.encode());
    } else     if (value is Region) {
      buffer.putUint8(131);
      writeValue(buffer, value.encode());
    } else     if (value is MusicAuthorizationStatus) {
      buffer.putUint8(132);
      writeValue(buffer, value.index);
    } else     if (value is RegionState) {
      buffer.putUint8(133);
      writeValue(buffer, value.index);
    } else     if (value is AuthorizationStatus) {
      buffer.putUint8(134);
      writeValue(buffer, value.index);
    } else     if (value is MapViewType) {
      buffer.putUint8(135);
      writeValue(buffer, value.index);
    } else {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 132: 
        ...
        return value == null ? null : MusicAuthorizationStatus.values[value];
      case 133: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : RegionState.values[value];
      case 134: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : AuthorizationStatus.values[value];
      case 135: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : MapViewType.values[value];
      default:
...
class MusicKit {
  ...
  Future<MusicAuthorizationStatus> requestPermission() async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as MusicAuthorizationStatus?)!;
    }
  }
...
class LocationManager {
  ...
  Future<AuthorizationStatus> currentPermissionStatus() async {
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as AuthorizationStatus?)!;
    }
  }
    ...
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final RegionState? arg_state = (args[1] as RegionState?);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final AuthorizationStatus? arg_status = (args[0] as AuthorizationStatus?);
    ...
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final MapViewType? arg_viewType = (args[0] as MapViewType?);
