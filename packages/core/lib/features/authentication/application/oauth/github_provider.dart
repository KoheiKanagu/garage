...
class GitHubProvider extends OAuthProvider {
  GitHubProvider({
    ...
    scopes.forEach(
      firebaseAuthProvider.addScope,
    );
  }
  @override
  final providerId = 'github.com';

  @override
  final style = const GitHubProviderButtonStyle();

  final Set<String> scopes;

  @override
  fba.GithubAuthProvider firebaseAuthProvider = fba.GithubAuthProvider();
...
const _githubBlack = Color(0xff24292f);
const _githubWhite = Color(0xffffffff);

const _backgroundColor = ThemedColor(
  _githubWhite,
  _githubBlack,
);

const _color = ThemedColor(
  _githubBlack,
  _githubWhite,
);
...
class GitHubProviderButtonStyle extends ThemedOAuthProviderButtonStyle {
  const GitHubProviderButtonStyle();
  ...
  @override
  String get assetsPackage => 'firebase_ui_oauth_github';

  @override
  String? get label => i18n.auth.sigh_in_with_github;
